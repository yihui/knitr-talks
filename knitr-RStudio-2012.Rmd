...
- New services dedicated to R Markdown

# RPubs: Easy Web Publishing for R

- One-click publishing of R Markdown documents

- Documents can contain arbitrary JavaScript

- Moderated comment streams

- Free for publicly accesible documents

- Early preview: [http://rpubs.com](http://rpubs.com)
...
- if you only have an R script, you can still do a report: `stitch()` or `card()`
